...
const venue = {
  ...
  addressLine:
    "No. 3, Jalan Tengku Ampuan Zabedah C9/C, 40100 Shah Alam, Selangor, Malaysia",
  mapsQuery: "Concorde Hotel Shah Alam",
  website: "https://www.concordehotelsresorts.com/concorde-hotel-shah-alam",
};
      ...
      <div className="mt-14 grid gap-10 lg:grid-cols-2">
          ...
          <div className="mt-8 space-y-6">
            ...
            <div>
              ...
              <ul className="mt-3 list-disc space-y-2 pl-5 text-slate-700">
                <li>
                  ...
                  Search the venue name in your preferred map app and follow
                  navigation.
                </li>
                ...
                <li>
                  ...
                  Plan for additional travel time during peak hours.
                </li>

                <li>
                  <span className="font-semibold">From the airport:</span> Use a
                  taxi or e-hailing service, or arrange private transfer based
                  on your itinerary.
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p className="mt-3 text-slate-700">
                Parking and drop-off areas are available at the hotel. Follow
                on-site signage and staff guidance upon arrival.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-3 text-slate-700">
                For venue-related questions, please refer to the{" "}
                <Link
        ...
        <section className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <p className="px-4 pb-4 pt-3 text-slate-600">
            Use the interactive map below to explore the surrounding area and
            plan your route.
          </p>
          ...
          <p className="mt-4 px-1 text-xs text-slate-500">
            Map is provided for convenience. Please verify your route and travel
            time using your preferred navigation app.
          </p>
        </section>
      </div>
    </main>
